...
// --- Konfigurasi Menu ---
const MENU_ITEMS = [
    { id: 1, name: "Espresso Shot", price: 25000, category: "Kopi", image: "img/product-kopi-1.jpg" },
    { id: 2, name: "Caffè Latte", price: 35000, category: "Kopi", image: "img/product-kopi-1.jpg" },
    { id: 3, name: "Caramel Macchiato", price: 40000, category: "Kopi", image: "img/product-kopi-1.jpg" },
    { id: 4, name: "Matcha Latte", price: 38000, category: "Non Coffee", image: "img/product-nonkopi-1.jpg" },
    { id: 5, name: "Red Velvet", price: 38000, category: "Non Coffee", image: "img/product-nonkopi-1.jpg" },
    { id: 6, name: "Chocolate Frap", price: 42000, category: "Non Coffee", image: "img/product-nonkopi-1.jpg" },
    { id: 7, name: "Croissant Original", price: 28000, category: "Makanan", image: "img/product-makanan-1.jpg" },
    { id: 8, name: "Tuna Sandwich", price: 45000, category: "Makanan", image: "img/product-makanan-1.jpg" },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Inisialisasi Payment/Invoice Page
...
const setupOrderForm = () => {
    ...
    const togglePaymentDetails = (method) => {
        if (method === 'Transfer' || method === 'E-Wallet') {
            ...
            // Logika menampilkan info spesifik (bisa lebih detail jika perlu)
            const detailsContent = document.getElementById('payment-details-content');
            
            let methodInfoHTML = '';
            let qrCodeSrc = 'img/qr-code-placeholder.png'; // Placeholder QR Code
            ...
            detailsContent.innerHTML = `
                ...
                <label for="upload_proof">Upload Bukti Pembayaran:</label>
                <input type="file" id="upload_proof" name="upload_proof" accept="image/*" required>
            `;
    ...
    orderForm.addEventListener('submit', (e) => {
        ...
        const orderData = {
            id: 'CV' + Date.now(), // ID Pesanan sederhana
        ...
        // Simpan data order ke sessionStorage (sebagai pengganti database/backend)
        ...
        // Redirect ke halaman pembayaran/invoice
...
const renderInvoiceDetails = () => {
    ...
    downloadBtn.addEventListener('click', () => {
        generateInvoiceText(orderData); // Panggil fungsi generate
    });
...
const generateInvoiceText = (order) => {
    ...
    // Membuat file Blob dan mendownload
...
const sendWhatsappOrder = (order) => {
    let message = `Halo Admin CoffeeVille, saya ${order.name} ingin mengkonfirmasi pesanan dengan detail:\n\n`;
    message += `*No. Pesanan:* ${order.id}\n`;
    message += `*Nama:* ${order.name}\n`;
    message += `*Alamat:* ${order.address}\n`;
    message += `*Opsi Pengantaran:* ${order.delivery_option}\n`;
    ...
    // Nomor WhatsApp target (ganti dengan nomor admin café)
    const whatsappNumber = '6281234567890'; // Contoh Nomor Admin
